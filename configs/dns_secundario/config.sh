...
ip addr add 192.168.50.12/24 dev eth1
...
#Chequeo archivo named.conf
echo "------------------------------------------------------------"
echo "Chequeando archivo named.conf"
echo "------------------------------------------------------------"
named-checkzone labredes.com /var/cache/bind/db.directa
echo "------------------------------------------------------------"
...
echo "El resultado de ls /var/cache/bind debe ser que estan los archivos db.directa y db.inversa"
ls /var/cache/bind
